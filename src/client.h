...
namespace http {
    ...
    class BaseClient {
       public:
        ...
        virtual std::expected<Response, std::string> get(const std::string& path) = 0;
        virtual std::expected<Response, std::string> post(const std::string& path, const std::string& body) = 0;
        virtual std::expected<Response, std::string> put(const std::string& path, const std::string& body) = 0;
        virtual std::expected<Response, std::string> del(const std::string& path) = 0;
        virtual void setCert(const std::string& cert_file) = 0;
    };
    ...
    class HttpClient : public BaseClient {
       ...
       public:
        ...
        std::expected<Response, std::string> get(const std::string& path) override {
        ...
        std::expected<Response, std::string> post(const std::string& path, const std::string& body) override {
        ...
        std::expected<Response, std::string> put(const std::string& path, const std::string& body) override {
            std::ostringstream request;
        ...
        std::expected<Response, std::string> del(const std::string& path) override {
        ...
        void setCert(const std::string& cert_file) override {
            // HTTP client doesn't use certificates
        }
    ...
    class HttpsClient : public BaseClient {
       ...
       public:
        HttpsClient(const std::string& host, int port) : host_(host), port_(port) {
            ssl_ctx_ = nullptr;
            ssl_ = nullptr;
        }
    ...
    class Client {
       ...
       public:
        ...
        void setCert(const std::string& cert_file) { client_->setCert(cert_file); }
    };
