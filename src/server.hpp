...
namespace http {
    ...
    class server {
       ...
       private:
        ...
        /**
         * This function serves as the main entry point for processing HTTP requests. It
         * looks up the appropriate handler based on the HTTP method and path, then executes
         * the handler and returns the response body.
         *
         * @param method The HTTP method of the request (GET, POST, PUT, DELETE, etc.)
         * @param path The URL path of the request
         * @return std::string The response body generated by the matched handler
         */
